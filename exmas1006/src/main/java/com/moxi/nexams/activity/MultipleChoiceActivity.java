...
import com.moxi.handwritinglibs.WritePadCommonView;
import com.moxi.nexams.R;
import com.moxi.nexams.adapter.test.MultipChoiceAdapter;
...
public class MultipleChoiceActivity extends BaseActivity implements View.OnClickListener {
    ...
    WritePadCommonView paintInvalidateRectView;
    ...
    private MultipChoiceAdapter cAdapter;
            ...
            public void moveDirection(boolean left, boolean up, boolean right, boolean down) {
                if (left) {
                    ...
                    if (page > 0) {
                        ...
                        if (typeIndex > 0) {
                            typeIndex--;
                            TitleUtils.moveToActivity(MultipleChoiceActivity.this, isHistory,
                            ...
                            Toastor.showToast(MultipleChoiceActivity.this, "已经是第一题了");
                        }
                    }
                } else if (right) {
                    saveBitMap(ppsId, page);
                    if (page < listDetails.size() - 1) {
                        ...
                        if (typeIndex < listType.size() - 1) {
                            ...
                            Toastor.showToast(MultipleChoiceActivity.this, "已经是最后一题了");
                        }
                    }
                }
            }
    ...
    private void resolveResult(final int page) {
        ...
        List<String> temp = (List<String>) aCache.getAsObject("ppsid_" + ppsId + "page_" + page);
        if (temp != null) {
            results = temp;
        } else {
        ...
        if (pdm.getPsjOption().equals("")) {
            ...
            //设置标题
            cAdapter = new MultipChoiceAdapter(this, "", pdm.getPsjOption(), results);
            recyclerTitle.setAdapter(cAdapter);
            cAdapter.setOnItemClickListener(new OnItemClickListener() {
                @Override
                public void onItemClick(View view, int position) {
                    if (isHistory) {
                        Toastor.showToast(MultipleChoiceActivity.this, "已经提交不能修改答案");
                    } else {
                        ...
                        aCache.put("ppsid_" + ppsId + "page_" + page, (Serializable) results);
                        cAdapter.setResult(results);
                    }
                }
