 ...
 */
public class HSlidableGridView extends GridView {
    Context context;
    ...
    public HSlidableGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }
    public HSlidableGridView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.context = context;
    }
    public HSlidableGridView(Context context) {
        super(context);
        this.context = context;
    }
    @Override
