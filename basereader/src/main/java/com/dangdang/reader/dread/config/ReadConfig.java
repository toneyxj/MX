...
public class ReadConfig {
    ...
    public int getReaderBgColor() {
        Log.e("ReaderBgColor",String.valueOf(mReaderBgColorDay));
        if (isNightMode()) {
            return mReaderBgColorNight;
        } else {
            return mReaderBgColorDay;
    ...
    public int getReadWidth() {
        ...
        if (getScreen() == 1) {
            ...
            if (readWidth<1000)readWidth=DRUiUtility.getScreenWith();
        } else {
            readWidth = DRUiUtility.getScreenWith();
        }
        APPLog.e("readWidth", readWidth);
        return readWidth;
    }
    ...
    public int getReadHeight() {
        ...
        if (getScreen() == 1) {
            ...
            if (readHeight>1000)readHeight=DRUiUtility.getScreenHeight();
        } else {
        ...
        APPLog.e("readHeight", readHeight);
        return readHeight;
    }
