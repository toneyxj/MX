...
//        String haha = GsonTools.obj2json(file);
        //设置intent的data和Type属性。
        String tempName = file.getName().substring(file.getName().lastIndexOf(".")).toLowerCase();
//        if (tempName.equals(".epub")||tempName.equals(".pdf")) {//!tempName.equals(".pdf") && !
//            intent = new Intent(Intent.ACTION_VIEW, Uri.fromFile(file));
//            intent.setClassName("com.onyx.reader", "com.onyx.reader.ReaderActivity");
//        } else {
//            intent = new Intent();
//            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//            //设置intent的Action属性
//            intent.setAction(Intent.ACTION_VIEW);
//            intent.setPackage("com.neverland.oreader");
//            intent.setDataAndType(Uri.fromFile(file), type);
//        }

        if (tempName.equals(".chm")){
            intent = new Intent();
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            //设置intent的Action属性
            intent.setAction(Intent.ACTION_VIEW);
            ...
            intent.setPackage("com.onyx.kreader");
//            intent = new Intent(Intent.ACTION_VIEW, Uri.fromFile(file));
//            intent.setClassName("com.onyx.kreader", "com.onyx.kreader.ui.ReaderTabHostActivity");
...
//            intent.setAction(Intent.ACTION_VIEW);
            //设置intent的Action属性
            intent.setDataAndType(Uri.fromFile(file), type);
//            share.setCache(Constant.LAST_READ, haha);
//            MXReaderManager.insertReadFile(context, file.getAbsolutePath(), Constant.MAIN_PACKAGE);
        }
