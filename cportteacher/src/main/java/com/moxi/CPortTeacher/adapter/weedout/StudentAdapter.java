...
public class StudentAdapter extends RecyclerView.Adapter {
    ...
    private int page;
    private List<List<StudentModel.StudentWeed>> lists;
    ...
    public StudentAdapter(Context context, List<StudentModel.StudentWeed> listData, int page) {
        this.context = context;
        this.page = page;
        lists = ListUtils.splitList(listData, 28);
    }
