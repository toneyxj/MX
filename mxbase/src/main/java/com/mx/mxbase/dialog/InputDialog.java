...
public class InputDialog extends Dialog implements View.OnClickListener {
    ...
    private boolean isDinsmiss = true;

    public InputDialog(Context context, int theme, String title, String hint, boolean isDinsmiss,
                       InputListener listener) {
        super(context, theme);
        this.hint = hint;
        this.title = title;
        this.listener = listener;
        this.isDinsmiss = isDinsmiss;
    }
    ...
    public static InputDialog getdialog(Context context, String title, String hint,
                                        InputListener listener) {
        return getdialog(context, title, hint, true, listener);
    }

    public static InputDialog getdialog(Context context, String title, String hint, boolean isDinsmiss,
                                        InputListener listener) {
        InputDialog dialog = new InputDialog(context, R.style.dialog, title,
                hint, isDinsmiss, listener);
