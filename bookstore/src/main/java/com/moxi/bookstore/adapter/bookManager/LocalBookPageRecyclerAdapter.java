...
public class LocalBookPageRecyclerAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (ebookDB == null) {
            ReadManagerPicUtils.getInstance().setLocationBookPic(context,((BookTypeViewHolder) holder).imgBookType,mode.filePath,((BookTypeViewHolder) holder).read_progress);
        } else {
