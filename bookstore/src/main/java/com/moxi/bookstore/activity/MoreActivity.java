...
public class MoreActivity extends BookStoreBaseActivity implements AdapterView.OnItemClickListener,
    ...
    private void showHistory(List<?> list) {
        gvAdapter3 = new HistoryGvAdapter(this, list, 330);
    ...
    private void showStore(List<?> list) {
        if (gvAdapter1==null) {
            gvAdapter1 = new StoreGvAdapter(this, list, 330);
    ...
    private void showBought(List<?> list) {
        if (gvAdapter2==null) {
            gvAdapter2 = new BoughtGvAdapter(this, list, 330);
...
//        finish();
    ...
    public void onLeftFling() {
        if (CurrentIndex >= totalIndex - 1) {
            ...
            if (flag == BUY && (CurrentIndex + 2) * 12 > bblist.size() && buyBookNumber > bblist.size()) {
                getBoughtBooks();
            } else {
                if (!isNoAdd)
                    CurrentIndex++;
