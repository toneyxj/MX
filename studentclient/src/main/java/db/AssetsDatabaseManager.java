...
public class AssetsDatabaseManager {
    ...
    private static String databasepath = "/data/data/%s/database"; // %s is packageName  /mnt/sdcard
     ...
     * @return
     */
    public SQLiteDatabase getDatabase(String pathPath, String dbName) {
