...
public class WrapClass {
	...
	public void init(ReadConfig config, Context context){
		...
		mCssPath = config.getCssPath();///data/data/com.moxi.bookstore/EpubCss/style.css
		mXdbPath = config.getDictXdbPath();//preread/dicts/dict-gbk.xdb
		mRulesPath = config.getDictRulesPath();//preread/dicts/rules.ini
		APPLog.e("WrapClass-mCssPath",mCssPath);
		APPLog.e("isSave-mCssPath",(new File(mCssPath)).exists());
