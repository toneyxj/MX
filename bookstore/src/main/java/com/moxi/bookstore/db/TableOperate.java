...
public class TableOperate {
     ...
     * @return 返回书籍对象
     */
    public String querypeogress(String tableName, String savePath) {
        String t = "";
        Cursor cursor = db.rawQuery("select "+TableConfig.E_PROGRESS+" from " + tableName + " where " + TableConfig.E_FILEPATHMD5 + " = '"+ MD5.stringToMD5(savePath) +"'",null);
        cursor.moveToFirst();
        if (!cursor.isAfterLast()) {
