...
public interface HttpService {
     ...
     * @return
     */
    @GET("/media/api.go?action=column&columnType=all_rec_dddj&isFull=1&returnType=json&deviceType=Android&channelId=30061&permanentId=&deviceSerialNo=&platformSource=DDDS-P&channelType=&token=&start=0&end=30")
