...
import com.mx.zhude.model.MXAppDetail;
    ...
    private void getALlInstallApp() {
        ...
        for (int i = 0; i < packages.size(); i++) {
            ...
            if ((packageInfo.applicationInfo.flags & ApplicationInfo.FLAG_SYSTEM) == 0) {
                //如果非系统应用全部显示
                if (tmpInfo.getName().equals("Home") || tmpInfo.getName().equals("ZhudeMain") || tmpInfo.getName().equals("zdReader") || tmpInfo.getName().equals("文件管理器")) {
//                    appList.add(tmpInfo);
                }else{
                    appList.add(tmpInfo);
                }
