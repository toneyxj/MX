 ...
 */
public class SaveDrawDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insure.setTag(this);
        discard.setTag(this);
        qiut.setOnClickListener(listener);
        insure.setOnClickListener(listener);
     ...
     *            如果点击确认返回控件
     */
    public static void getdialog(Context context, String content,
                                 View.OnClickListener listener) {
