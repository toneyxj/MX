 ...
 */
public class HJSettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int getMainContentViewId() {
        return R.layout.mx_activity_new_setting;
    }
    ...
    private void init() {
        ...
        findViewById(R.id.ll_setting_application).setOnClickListener(this);
...
//                startActivity(other);
                Intent other = new Intent(this, HJOtherSettingActivity.class);
                startActivity(other);
                break;
            //应用
            case R.id.ll_setting_application:
//                //电源管理
            ...
            case R.id.tv_setting_online_update:
                ...
                OkHttpUtils.post().url(Constant.CHECK_LOWER_UPDATE).addParams("versionName", AppUtil.getPackageInfo(this).versionName).build().execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        if (isfinish)return;
                        Toastor.showToast(HJSettingActivity.this, "网络请求失败，请检查网络");
                    }
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            if (lowerVersion > Constant.LOCAL_VIR_VERSION) {
                                ...
                                sound.setComponent(cnSound);
                                HJSettingActivity.this.startActivity(sound);
                            } else {
                                showToast("已经是最新版本了！！！");
//                                new UpdateUtil(HJSettingActivity.this, HJSettingActivity.this).startUpdate();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            new UpdateUtil(HJSettingActivity.this, HJSettingActivity.this).startUpdate();
