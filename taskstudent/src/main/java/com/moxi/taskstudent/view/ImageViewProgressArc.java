...
import com.moxi.taskstudent.TaskApplication;
import com.moxi.taskstudent.taskInterface.UploadImageStatus;
import com.moxi.taskstudent.utils.ImageLoadUtils;
...
public class ImageViewProgressArc extends ImageView implements View.OnClickListener{
   ...
   private String path;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (arcWidth> TaskApplication.ScreenWidth/10)arcWidth=TaskApplication.ScreenWidth/10;
