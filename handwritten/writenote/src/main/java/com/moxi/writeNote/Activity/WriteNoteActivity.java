...
import com.moxi.handwritinglibs.listener.InvallClickListener;
...
public class WriteNoteActivity extends WriteBaseActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener ,InvallClickListener{
    /**
     * 文件信息类
     */
     ...
     * @param isAdd 是否显示
     */
    private void addNoteWrite(boolean isAdd) {
