package com.moxi.studentb.view;
...
import com.moxi.studentb.R;
import com.moxi.studentb.util.Utils;

/**
 * Created by Archer on 16-07-28.
 */
public class DonutProgress extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //(270 + getProgressAngle()) % 360  计算开始角度
        canvas.drawArc(unfinishedOuterRect, (270 + getProgressAngle()) % 360, 360 - getProgressAngle(), false, unfinishedPaint);
        ...
        if (!TextUtils.isEmpty(getInnerBottomText())) {
            ...
            canvas.drawText(getInnerBottomText(), (getWidth() - textPaint.measureText(text)) / 2.0f,
                    (getWidth() + innerBottomTextPaint.descent() + innerBottomTextPaint.ascent()*2) / 2.0f, innerBottomTextPaint);
        }
